...
extends Controller
{
  GET("/learn-japanese/") ->- { _ =>
    200 (fileContent("core/resources/static/learn-japanese/")("index.html")) ContentType "text/html; charset=UTF-8"
  }
  ...
  GET("/learn-japanese/*") ->- { implicit context =>
    for {
      ...
      200 (fileContent("core/resources/static/learn-japanese/")(path))
    }
  }
